defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    ...
    |> Multi.run(operation, fn repo, changes ->
      ...
      update_balance(repo, account, value, operation_name)
    end)
  end
  ...
  defp handle_cast({:ok, value}, balance, :account_deposit), do: Decimal.add(balance, value)
  defp handle_cast({:ok, value}, balance, :account_withdraw), do: Decimal.sub(balance, value)
